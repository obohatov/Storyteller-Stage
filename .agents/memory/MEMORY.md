...
- [Production proxy topology](production-proxy-topology.md) — Production has four trusted hops before the platform client-IP entry; prefixes in X-Forwarded-For are caller-controlled.
